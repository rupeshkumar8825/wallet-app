    ...
    <div className="flex">
        <div className="w-72 border-r border-slate-300 min-h-screen mr-4 pt-28">
            <div>
                ...
                <SidebarItem href={"/p2p"} icon={<P2PTransferIcon/>} title = {"P2PTransfer"}></SidebarItem>
            </div>
        </div>
            {children}
    </div>
...
// below code to fetch the value of the icon for each of the sidebars for this purpose 
